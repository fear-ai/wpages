Status for WPages tooling and tests
  ...
  - Header validation strips CR/LF, lowercases column names, and enforces exact column order when strict_header is True (default); header errors include the path.
